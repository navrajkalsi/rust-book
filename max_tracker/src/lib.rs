...
mod tests {
    ...
    impl Messenger for MockMessenger {
        fn send(&self, message: &str) {
            // can borrow mutably or immutably, irrespective of the underlying mutability of the
            // var, with RefCell
            // NOTE The RefCell<T> keeps track of how many Ref<T> and RefMut<T> smart pointers are currently active.
